...
<h2 class="page-header">{{ ucfirst('payment modes') }}</h2>

<div class="panel panel-default">
    <div class="panel-heading">
        List of {{ ucfirst('payment modes') }}
    </div>
    ...
    <div class="panel-body">
        ...
        <a href="{{url('payment_modes/create')}}" class="btn btn-primary" role="button">Add payment mode</a>
    </div>
</div>
